...
bool Engine::EventManager::addBinding(Binding * t_binding)
{
...
bool Engine::EventManager::removeBinding(const std::string& t_name)
{
...
void Engine::EventManager::setFocus(const bool & t_focus)
{
	m_hasFocus = t_focus;
}

void Engine::EventManager::handleEvent(sf::Event & t_event)
{
...
void Engine::EventManager::loadBindings()
{
